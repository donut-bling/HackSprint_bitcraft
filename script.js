...
function checkAnswer(num1, num2) {
    ...
    document.getElementById('feedback').textContent = userAnswer === correctAnswer ? "Correct!" : `Wrong! The correct answer was ${correctAnswer}.`;
    document.getElementById('answer').value = '';
    document.getElementById('multiplicationGame').style.display = 'none';   
